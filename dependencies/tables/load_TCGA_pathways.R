...
source('/Users/scao/Desktop/all/projects/cptac3/mutation_effect/scripts/R/Mutational_Impact/cptac2p_analysis/phospho_network/phospho_network_shared.R')
...
for (pathway_name in pathway_names) {
  if (pathway_name == "Cell Cycle") {
    curated_gene_tab <- read_excel("/Users/scao/Desktop/all/projects/cptac3/mutation_effect/scripts/R/Mutational_Impact/TCGA-pathway-template.xlsx", 
...
load(paste0("~/Box/pan3can_shared_data/analysis_results/", "2015-08-01_Gene_Set.RData"))
